                                        ...
                                        <tbody>
                                            ...
                                            <tr class="cart_single">
                                                ...
                                                <td class="product-thumbnail">
                                                    <a href="#!">
                                                        <img width="57" height="70" src="<?=$_SESSION['cart']['image_url']?>" 
                                                    class="attachment-shop_thumbnail size-shop_thumbnail wp-post-image" alt="#!"  />
                                                    </a>
                                                </td>
                                                <td class="product-name" data-title="Product">
                                                    <a href="#!"><?=$_SESSION['cart']['product_name'] ?></a> </td>

                                                <td class="product-price" data-title="Price">
                                                    <span class="woocommerce-Price-amount amount"><span class="woocommerce-Price-currencySymbol">&pound;</span><?=$item['price'] *$item['quantity'] ?></span>
                                                </td>
