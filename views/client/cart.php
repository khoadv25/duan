  ...
  <?php if (!empty($cartUserID)): ?>
                      ...
                      <form action="https://html.themexriver.com/" method="post">
                          <table class="shop_table shop_table_responsive cart">
                              ...
                              <tbody>
                                  <?php
                                    if (!empty($cartUserID)) :
                                        foreach ($cartUserID as  $item) :

                                    ?>
                                          <tr class="cart_single">
                                              <td class="product-remove">
                                                  <a href="<?= BASE_URL . '?act=cart-del&cartID=' . $item['cart_id'] ?>" class="remove" title="Remove this item" data-product_id="8" data-product_sku="my name is">&times;</a>
                                              </td>
                                              <td class="product-thumbnail">
                                                  <a href="#!">
                                                      <img width="57" height="70" src="<?= $item['image_url'] ?>" class="attachment-shop_thumbnail size-shop_thumbnail wp-post-image" alt="#!" />
                                                  </a>
                                              </td>
                                              ...
                                              <td class="product-price" data-title="Price">
                                                  <span class="woocommerce-Price-amount amount"><span class="woocommerce-Price-currencySymbol"></span><?= number_format($item['product_price']) ?> </span>
                                              </td>
                                            
                                              <td class="product-quantity" data-title="Quantity">
                                                  <div class="quantity text-center mx-4">
                                                      <a href="<?= BASE_URL . '?act=cart-des&cartID=' . $item['cart_id'] ?>" class="product-count input-text qty product-count">-</a>
                                                      <span><?= $item['cart_quantity'] ?></span>
                                                      <a href="<?= BASE_URL . '?act=cart-inc&cartID=' . $item['cart_id'] ?>">+</a>

                                                  </div>
                                              </td>

                                              <td class="product-subtotal" data-title="Total">
                                                  <span class="woocommerce-Price-amount amount"><span class="woocommerce-Price-currencySymbol"> </span><?= number_format($item['cart_quantity'] * $item['product_price']) ?> VND</span>
                                              </td>
                                          </tr>
                                  <?php
                                        endforeach;
                      ...
                      <div class="cart-collaterals">
                          <div class="cart_totals calculated_shipping">
                                  ...
                                  <tr class="cart-subtotal">
                                      ...
                                      <td data-title="Subtotal"><span class="woocommerce-Price-amount amount">
                                              ...
                                              <?php
                                                ...
                                                foreach ($cartUserID as $key => $value) {
                                                ...
                                                echo "Tổng số tiền: " . number_format($totalPrice)  . ' ' . 'VND';
                                                ?>
                                          </span>
                                      </td>
                                  </tr>
                              ...
                              <div class="wc-proceed-to-checkout">
                                  <a href="<?= BASE_URL . '?act=checkout' ?>" class="checkout-button thm-btn thm-btn__2 no-icon br-0 alt wc-forward">
                                      <span class="btn-wrap">
    ...
    <a class="" href=""><h3 class="text-center mt-4 ">Sản Phẩm Mới Ra Mắt ( click )</h3></a>
